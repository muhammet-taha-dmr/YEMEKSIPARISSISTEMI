...
Features:
1.Menu Browsing: View menus from multiple restaurants.
2.Ordering System: Add items to cart and place orders.
3.User Management: Customer registration and profile management.
4.Order Tracking: View order summary and status.
5. Discounts: Apply coupon codes for discounts.

Multiple Payment Methods: 
Pay via Credit Card, Cash, or Digital Wallet.
...
Project Status:
 ...
 5.Discount System
Muhammet Taha Demir / 230303041 Fall 2025 - Object Oriented Programming Final Project
